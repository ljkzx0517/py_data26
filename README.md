[Uploading AI기반데이터분석_04_판다스_데이터처리_실습_최영진.ipynb…]()
{
 "cells": [
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "    print(content)  # 결과를 화면에 출력한다.\n",
    "\n",
    "print(\"----- 끝 -----\") # 결과를 화면에 출력한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "    content = f.readlines() # 파일의 모든 줄을 읽어 리스트로 저장.\n",
    "    for line in content: # 반복문을 사용하여 항목을 각각 차례대로 처리한다.\n",
    "        print(line, end='') # 결과를 화면에 출력한다\n",
    "        \n",
    "print(\"----- 끝 -----\")"
   ]
  },
  {
   ...
   "source": [
    "with open(sample_file, mode = 'r') as f: # 파일을 연다.\n",
    "    line = f.readline()\n",
    "    while line: # 조건이 참인 동안 반복해서 실행한다.\n",
    "        print(line, end='') # 결과를 화면에 출력한다.\n",
    "        line = f.readline()"
   ]
  },
  {
   ...
   "source": [
    ...
    "# 각 줄 끝의 \\n도 포함해서 가져옵니다\n",
    "with open(sample_file, mode = 'r') as f: # 파일을 연다.\n",
    "    for line in f: # 반복문을 사용하여 각 항목을 차례대로 처리한다.\n",
    "        print(line, end='')# 결과를 화면에 출력한다.\n",
    "\n",
    "print(\"----- 끝 -----\") # 결과를 화면에 출력한다."
   ]
  },
  {
   ...
   "source": [
    ...
    "import glob # glob 라이브러리를 불러온다.\n",
    "txt_files = glob.glob('../data/*.txt') # 지정한 경로의 파일 목록을 가져온다.\n",
    "for file in txt_files: # 반복문을 사용하여 각 항목을 차례대로 처리한다.\n",
    "    with open(file, mode = 'r') as f: # 파일을 연다.\n",
    "        print(f.read()) # 파일의 전체 내용을 읽는다.\n",
    "print(\"----- 끝 -----\") # 결과를 화면에 출력한다."
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "# 양쪽 공백 제거 \n",
    "b1=\" 작은 일에 성실한 사람은      큰일에도 성실하고 \" # 변수에 값을 저장한다.\n",
    "b1.strip() # 문자열 양쪽의 지정한 문자를 제거한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "# 변수에 값을 저장한다.\n",
    "text=\"....작은 일에 성실한 사람은, 큰일에도 성실하고....\" # 결과를 화면에 출력한다.\n",
    "print(text.strip('.'))# 결과를 화면에 출력한다.\n",
    "print(text.lstrip('.')) # 결과를 화면에 출력한다.\n",
    "print(text.rstrip('.')) # 결과를 화면에 출력한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# ,로 문자열 분리\n",
    "text=\"....작은 일에 성실한 사람은, 큰일에도 성실하고....\" # 변수에 값을 저장한다.\n",
    "print(text.split(',')) # 변수에 값을 저장한다.\n",
    "print(text.strip('.').split(',')) # 변수에 값을 저장한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# .으로 문자열 분리\n",
    "numbers=\"1. 2. 3. 4. 5. 6\" # 변수에 값을 저장한다.\n",
    "numbers.split('.') # 문자열을 지정한 구분자로 나눈다."
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: pandas in C:\\Users\\user\\anaconda3\\envs\\pydata26\\Lib\\site-packages (3.0.5)\n",
      "Requirement already satisfied: numpy>=2.3.3 in C:\\Users\\user\\anaconda3\\envs\\pydata26\\Lib\\site-packages (from pandas) (2.5.2)\n",
      "Requirement already satisfied: python-dateutil>=2.8.2 in C:\\Users\\user\\anaconda3\\envs\\pydata26\\Lib\\site-packages (from pandas) (2.9.0.post0)\n",
      "Requirement already satisfied: tzdata in C:\\Users\\user\\anaconda3\\envs\\pydata26\\Lib\\site-packages (from pandas) (2026.3)\n",
      "Requirement already satisfied: six>=1.5 in C:\\Users\\user\\anaconda3\\envs\\pydata26\\Lib\\site-packages (from python-dateutil>=2.8.2->pandas) (1.17.0)\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "source": [
    ...
    "sample_df = pd.read_csv(sample_file)# CSV 파일을 읽어 데이터프레임으로 저장한다.\n",
    "sample_df"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "sample_df.to_csv('../data/sample_data_copy.csv', index=False) # 데이터프레임을 CSV 파일로 저장한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "          Age Gender         City\n",
       "Name                             \n",
       "Alice    24.0      F     New York\n",
       "Bob       NaN      M  Los Angeles\n",
       "Charlie  22.0      M          NaN\n",
       "David    29.0      M      Chicago\n",
       "Edward    NaN      M      Houston\n",
       "Alice    24.0      F     New York\n",
       "Susan    32.0      F      Houston"
      ]
     },
     "execution_count": 49,
     "metadata": {},
   ...
   "source": [
    "df2 = pd.read_csv('../data/sample_data_copy.csv', index_col='Name') # CSV 파일을 읽고 지정한 컬럼을 인덱스로 설정한다.\n",
    "df2"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "t_df = pd.read_csv(titanic_data, sep='\\t') # CSV 파일을 읽고 지정한 구분자를 기준으로 데이터프레임을 생성한다.\n",
    "t_df.head(10) # 데이터프레임의 앞부분 행을 확인한다."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    "# 뒷부분 확인\n",
    "t_df.tail(10) # 데이터프레임의 뒷부분 행을 확인한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# 데이터 개수/형태 확인\n",
    "t_df.shape # 데이터프레임의 행과 열 개수를 확인한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "#데이터의 기본 통계치 보기\n",
    "t_df.describe() # 수치형 데이터의 기초 통계 정보를 확인한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# 데이터 구성 정보 확인하기\n",
    "t_df.info() # 데이터프레임의 구조와 자료형 정보를 확인한다."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "sample_backup_df = sample_df.copy() # 데이터프레임을 복사하여 별도 객체로 저장한다.\n",
    "sample_backup_df # 해당 코드의 작업을 수행한다.\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "# sample_df\n",
    "sample_df.columns = [col.lower() for col in sample_df.columns] # 데이터프레임의 컬럼명을 변경한다.\n",
    "sample_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "sample_df = sample_df.rename(columns=str.lower) # 컬럼명 또는 인덱스 이름을 변경한다.\n",
    "sample_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   ...
   "source": [
    "sample_df = sample_df.rename(columns=str.upper) #컬럼명 또는 인덱스 이름을 변경한다.\n",
    "sample_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   ...
   "source": [
    "sample_df = sample_df.rename(columns=str.capitalize) # 컬럼명 또는 인덱스 이름을 변경한다.\n",
    "sample_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   ...
   "source": [
    "# 컬럼명의 첫 글자는 소문자로, 나머지는 대문자로 수정\n",
    "sample_df = sample_df.rename(columns=lambda x: x[0].lower() + x[1:].upper()) # 컬럼명 또는 인덱스 이름을 변경한다.\n",
    "sample_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "# 행 데이터 삭제하기\n",
    "drop_index = [2, 4, 152, 154] # 변수에 값을 저장한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "..                                                 ...     ...   ...    ...   \n",
       "147                  Byles, Rev. Thomas Roussel Davids    male  42.0      0   \n",
       "148                         Bateman, Rev. Robert James    male  51.0      0   \n",
       "149                  Pears, Mrs. Thomas (Edith Wearne)  female  22.0      1   \n",
       "150                    van Billiard, Mr. Austin Blyler    male  40.5      0   \n",
       "151                        Williams, Mr. Charles Duane    male  51.0      0   \n",
       "\n",
       "     Parch       Ticket     Fare Cabin Embarked  \n",
       "0        0    A/5 21171   7.2500   NaN        S  \n",
       "1        0     PC 17599  71.2833   C85        C  \n",
       ...
       "..     ...          ...      ...   ...      ...  \n",
       "147      0       244310  13.0000   NaN        S  \n",
       "148      0  S.O.P. 1166  12.5250   NaN        S  \n",
       "149      0       113776  66.6000    C2        S  \n",
       "150      2     A/5. 851  14.5000   NaN        S  \n",
       "151      1     PC 17597  61.3792   NaN        C  \n",
       "\n",
   ...
   "source": [
    ...
    "t_df = t_df.reset_index(drop=True) # 인덱스를 초기화하고 기본 인덱스로 되돌린다.\n",
    "t_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "t_df = t_df.rename(columns=str.lower) # 컬럼명 또는 인덱스 이름을 변경한다.\n",
    "t_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   ...
   "source": [
    ...
    "t_df = t_df.set_index('passengerid') # 지정한 컬럼을 인덱스로 설정한다.\n",
    "t_df # 해당 코드의 작업을 수행한다."
   ]
  },
  {
   ...
   "source": [
    "# index를 컬럼으로 만들고, index를 RangeIndex로 reset하기\n",
    "# 인덱스를 초기화하고 기본 인덱스로 되돌린다.\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "151    151          156         0       1       Williams, Mr. Charles Duane   \n",
       "122    122          125         0       1       White, Mr. Percival Wayland   \n",
       "4        4            7         0       1           McCarthy, Mr. Timothy J   \n",
       "13      13           16         1       2  Hewlett, Mrs. (Mary D Kingcome)    \n",
       "9        9           12         1       1          Bonnell, Miss. Elizabeth   \n",
       "92      92           95         0       3                 Coxon, Mr. Daniel   \n",
       "52      52           55         0       1    Ostby, Mr. Engelhart Cornelius   \n",
       "31      31           34         0       2             Wheadon, Mr. Edward H   \n",
       "114    114          117         0       3              Connors, Mr. Patrick   \n",
       "94      94           97         0       1         Goldschmidt, Mr. George B   \n",
       "\n",
       "        sex   age  sibsp  parch      ticket     fare cabin embarked  \n",
       "151    male  51.0      0      1    PC 17597  61.3792   NaN        C  \n",
       "122    male  54.0      0      1       35281  77.2875   D26        S  \n",
       "4      male  54.0      0      0       17463  51.8625   E46        S  \n",
       "13   female  55.0      0      0      248706  16.0000   NaN        S  \n",
       "9    female  58.0      0      0      113783  26.5500  C103        S  \n",
       "92     male  59.0      0      0      364500   7.2500   NaN        S  \n",
       "52     male  65.0      0      1      113509  61.9792   B30        C  \n",
       "31     male  66.0      0      0  C.A. 24579  10.5000   NaN        S  \n",
       "114    male  70.5      0      0      370369   7.7500   NaN        Q  \n",
       "94     male  71.0      0      0    PC 17754  34.6542    A5        C  "
      ]
     },
     "execution_count": 115,
     "metadata": {},
   ...
   "source": [
    "# 'age' 기준으로 정렬\n",
    "# 데이터프레임의 앞부분 행을 확인한다.\n",
    "t_df = t_df.sort_values(by='age').head(10)\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "t_df"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "t_df = t_df.sort_values(by=['age', 'pclass'])\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "t_df"
   ]
  },
  {
   ...
   "source": [
    "# pclass는 오름차순으로, age는 내림차순으로 정렬\n",
    "# 지정한 컬럼을 기준으로 데이터를 정렬한다.\n",
    "t_df = t_df.sort_values(by=['pclass', 'age'], ascending=[True, False])\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "t_df"
   ]
  },
  {
   ...
   "source": [
    "# index를 기준으로 정렬\n",
    "# 변수에 값을 저장한다.\n",
    "t_df = t_df.sort_index(ascending=False)\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "t_df"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    "# (행,열) 데이터 추출\n",
    "# 라벨을 기준으로 행 또는 열을 선택한다.\n",
    "score_df.loc[score_df['국어'] >= 90, ['이름', '국어']]"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# 데이터를 읽으면서 탭을 기준으로 분리하여 데이터 프레임으로 만들기\n",
    "# CSV 파일을 읽고 지정한 구분자를 기준으로 데이터프레임을 생성한다.\n",
    "titanic_df = pd.read_csv(titanic_data, sep='\\t')\n",
    "# 데이터프레임의 앞부분 행을 확인한다.\n",
    "titanic_df.head(10)"
   ]
  },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "108                                    Rekic, Mr. Tido    male  38.00      0   \n",
       ...
       "132     Robins, Mrs. Alexander A (Grace Charity Laury)  female  47.00      1   \n",
       "135                                 Richard, Mr. Emile    male  23.00      0   \n",
       "138                                Osen, Mr. Olaf Elon    male  16.00      0   \n",
       "141                           Nysten, Miss. Anna Sofia  female  22.00      0   \n",
  ...
  },
  {
   ...
   "source": [
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       "154    S\n",
       "155    C\n",
       "Name: Embarked, Length: 156, dtype: str"
      ]
     },
     "execution_count": 207,
     "metadata": {},
   ...
   "source": [
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[11]]"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]][2:6]\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]][:-1]\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]][::3]\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]][-1:]\n",
    "# 해당 코드의 작업을 수행한다.\n",
    "titanic_df[titanic_df.columns[0]][::-1]"
